...
open class ChartViewBase: NSUIView, ChartDataProvider, AnimatorDelegate
{
    ...
    {
        //changes y positions according to the finger not graph lines
        NotificationCenter.default.post(name: Notification.Name("setyposition"), object: nil, userInfo: ["yvalue": pt.y])
        NotificationCenter.default.post(name: Notification.Name("setfeedyposition"), object: nil, userInfo: ["yvalue": pt.y])
        NotificationCenter.default.post(name: Notification.Name("setgrowthfeedyposition"), object: nil, userInfo: ["yvalue": pt.y])
        NotificationCenter.default.post(name: Notification.Name("setharvestyposition"), object: nil, userInfo: ["yvalue": pt.y])
